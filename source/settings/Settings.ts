...
export class SettingLimitedMaxTrigger
	extends SettingLimitedMax
	implements SettingTrigger
{
	trigger: number;
...
export class SettingLimitedTrigger
	extends SettingLimited
	implements SettingTrigger
{
	trigger: number;
...
export class SettingThresholdMax
	extends SettingThreshold
	implements SettingMax
{
	max: number;
...
export class SettingBuySellThreshold
	extends SettingThreshold
