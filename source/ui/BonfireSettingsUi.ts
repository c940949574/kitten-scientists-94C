	...
	constructor(
		...
		this.addChildrenContent([
			new SettingsList(this, {
				...
				coalesceArray(
					this.host.game.bld.buildingGroups.flatMap((buildingGroup) => [
						...
						buildingGroup !==
						this.host.game.bld.buildingGroups[
							this.host.game.bld.buildingGroups.length - 1
						]
							? new Delimiter(this)
							: undefined,
					]),
			...
			new SettingsList(this, {
				...
				new BuildingUpgradeSettingsUi(
					this,
					settings.upgradeBuildings,
					locale,
					settings,
				),
			]),
